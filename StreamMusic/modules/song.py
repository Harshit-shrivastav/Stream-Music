...
def song(client, message):
    ...
    for i in message.command[1:]:
        query += " " + str(i)
    print(query)
    m = message.reply("𝐅𝐢𝐧𝐝𝐢𝐧𝐠 💫 𝐓𝐡𝐞 𝐒𝐨𝐧𝐠 🎧 𝐅𝐫𝐨𝐦 𝗘𝗵𝘀𝗮𝗮𝘀 ❤️ 𝐒𝐞𝐫𝐯𝐞𝐫 🌎...")
    ...
    try:
        ...
        print(str(e))
        return
    m.edit("𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝 ✨ 𝐒𝐨𝐧𝐠 🎸 𝐅𝐫𝐨𝐦 𝗘𝗵𝘀𝗮𝗮𝘀 🥀 𝐒𝐞𝐫𝐯𝐞𝐫 🌎...")
    try:
        with youtube_dl.YoutubeDL(ydl_opts) as ydl:
            info_dict = ydl.extract_info(link, download=False)
            audio_file = ydl.prepare_filename(info_dict)
            ydl.process_info(info_dict)
        rep = "🎵 𝐔𝐩𝐥𝐨𝐚𝐝𝐞𝐝 𝐁𝐲 :- ✨ @ehsaasmusic_bot ❤️"
        ...
        m.edit("𝐘𝐨𝐮𝐭𝐮𝐛𝐞  𝐄𝐫𝐫𝐨𝐫 ❌ 𝐂𝐨𝐧𝐭𝐚𝐜𝐭 𝐎𝐰𝐧𝐞𝐫 🥀 @ehsaasmusic_bot ❤️")
        print(e)
